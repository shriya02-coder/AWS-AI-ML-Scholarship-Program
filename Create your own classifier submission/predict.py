...
def predict(image_path, model, device, top_k=1):
    ...
    return top_prob.squeeze().tolist(), top_classes.squeeze().tolist()
...
def main():
    ...
    # Reverse the class_to_idx dictionary to map indices to classes
    ...
    if args.category_names:
        ...
        top_class_names = [category_names[cls] for cls in top_classes]
    else:
