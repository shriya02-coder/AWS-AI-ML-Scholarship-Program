...
def calculates_results_stats(results_dic):
    ...
    # Introduce unique variables for tracking counts
    total_images = 0
    correctly_classified_dogs = 0
    correctly_classified_non_dogs = 0
    correctly_classified_breeds = 0
    ...
    for key in results_dic:
        ...
        # Pet Image Label is NOT a Dog
            ...
            if results_dic[key][4] == 0:
                ...
                correctly_classified_non_dogs += 1
    ...
    table_data = [
        ...
        ["Correctly Matched Labels", correctly_matched_labels],
        ["Total Dog Images", total_dog_images],
        ["Correctly Classified Dogs", correctly_classified_dogs],
        ["Correctly Classified Non-Dogs", correctly_classified_non_dogs],
        ["Correctly Classified Breeds", correctly_classified_breeds],
        ["Results Stats Dictionary", results_stats_dic]
    ]
